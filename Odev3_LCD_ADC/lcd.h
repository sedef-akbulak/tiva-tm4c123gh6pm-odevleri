...
void lcd_yaz(char* s);
//===========================================================================
void baslangic(void)   //LCD baï¿½langï¿½ï¿½ ayarlarï¿½nï¿½ yapar.
{
...
//===========================================================================
void LCD_sil(void)   //LCD ekranï¿½nï¿½ siler.
{
	GPIOPinWrite(GPIO_PORTE_BASE, RS | RW | EN, 0x00);
	SysCtlDelay(sure);
	GPIOPinWrite(GPIO_PORTB_BASE, D7 | D6  | D5 | D4, 0x00);
...
char veri(char deger)
{
	GPIOPinWrite(GPIO_PORTB_BASE, D7 | D6  | D5 | D4, (0xF0 & deger)); //Yï¿½KSEK 4 Bï¿½T
	veri_yaz();
	GPIOPinWrite(GPIO_PORTB_BASE, D7 | D6  | D5 | D4, ((deger & 0x0F) << 4));//Dï¿½ï¿½ï¿½K 4 Bï¿½T
	veri_yaz();
}
//===========================================================================
void veri_yaz(void)
