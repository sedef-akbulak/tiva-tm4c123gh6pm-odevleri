...
void printf( char* s);
//===========================================================================
void baslangic(void)   //LCD başlangıç ayarlarını yapar.
{
...
//===========================================================================
void LCD_sil(void)   //LCD ekranını siler.
{
	GPIOPinWrite(GPIO_PORTE_BASE, RS | RW | EN, 0x00);
	SysCtlDelay(sure);
	GPIOPinWrite(GPIO_PORTB_BASE, D7 | D6  | D5 | D4, 0x00);
...
char veri(char deger)
{
	GPIOPinWrite(GPIO_PORTB_BASE, D7 | D6  | D5 | D4, (0xF0 & deger)); //YÜKSEK 4 BİT
	veri_yaz();
	GPIOPinWrite(GPIO_PORTB_BASE, D7 | D6  | D5 | D4, ((deger & 0x0F) << 4));//DÜŞÜK 4 BİT
	veri_yaz();
}
//===========================================================================
void veri_yaz(void)
